...
No — in every one of the 80 countries analyzed, the percentage of workforce displaced exceeds the percentage of new roles created, producing a negative net workforce change in every industry. This means role creation is not currently a sufficient offset anywhere in the dataset, and reskilling/redeployment programs need to close that gap directly rather than assuming the market will self-correct.
...
| Highest-risk industry | Administrative & Clerical (0.79 automation risk, 9.2% displaced) | Clear #1 priority for reskilling investment |
| Lowest-risk industry | Healthcare & Life Sciences (0.22 automation risk, 2.1% displaced) | Most insulated sector in the dataset |
...
This project answers that need by combining descriptive statistics, correlation analysis, and industry/region/country-level aggregation across a 20,800-record dataset spanning 2020–2026. Instead of a single global adoption number, the analysis breaks displacement down by industry, income group, gender, and geography, and directly tests whether new-role creation offsets displacement — surfacing a clear, prioritized answer (it does not, anywhere in the dataset) that leadership can act on immediately rather than a vague directional trend.
...
### 1. AI Adoption Index Distribution (Histogram)
...
### 2. Workforce Displacement Distribution (Histogram)
...
### 4. AI Adoption by Region (Horizontal Bar Chart)
...
### 5. AI Adoption Over Time (Line Chart, 2020–2026)
...
### 6. Workforce Displacement Over Time (Line Chart, 2020–2026)
...
### 9. AI Adoption vs. Workforce Displacement (Scatter Plot)
...
### 10. Workforce Displacement by Industry (Boxplot)
...
### 11. Automation Risk by Industry (Bar Chart)
...
### 12. Top 10 Countries by AI Adoption (Bar Chart)
...
### 13. AI Skill Wage Premium by Income Group (Pie Chart)
...
### 14. Female Workforce Share vs. Female Displacement Share (Scatter Plot)
...
### 15. AI Tool Adoption by Income Group (Pie Chart)
